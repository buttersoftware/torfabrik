...
class PriceType extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        $builder
                ...
                ->add('weekdayto', 'choice', array('label' => 'Wochentag bis', 'attr' => array('class' => 'input-xxlarge'),
                    'choices' => array('0' => 'Montag', '1' => 'Dienstag', '2' => 'Mittwoch', '3' => 'Donnerstag', '4' => 'Freitag', '5' => 'Samstag', '6' => 'Sonntag'),
                    'preferred_choices' => array('6'), 'required' => true))
                ->add('timefrom', 'time', array('label' => 'Uhrzeit von', 'attr' => array('class' => 'input-xxlarge')))
                ->add('timeto', 'time', array('label' => 'Uhrzeit bis', 'attr' => array('class' => 'input-xxlarge')))
